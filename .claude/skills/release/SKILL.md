...
name: release
description: >-
  Create and publish releases for the Hongdown project.
...
~~~~~
 ...
 1.  Ensure you're on the correct branch and it's up to date.

 2.  Run tests and quality checks to ensure everything passes:
...
~~~~~
 ...
 1.  Update *CHANGES.md*: Find the section for the version being released and
...
~~~~~
 ...
 1.  Create the tag (without `v` prefix).  Always use `-m` to provide a tag
...
~~~~~
 ...
 1.  If a newer maintenance branch exists, follow these sub-steps:
...
~~~~~~
 ...
 1.  If no newer maintenance branch exists, merge to `main`:
...
~~~~~
 ...
 1.  Add a section for the first patch version in *CHANGES.md*:
